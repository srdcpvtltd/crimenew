            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('category.add')}}" id="add-form" method="POST" enctype="multipart/form-data">
                                ...
                                <table width="100%" class="table" id="dt-tbl">
                                    ...
                                    @foreach($records AS $record)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn btn-sm btn-primary" data-id="{{$record->ID}}" data-name="{{$record->Category}}" data-toggle="modal" data-target="#editModal">Edit</a>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('category.edit')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="status_name">Category</label>
